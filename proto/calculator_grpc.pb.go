...
func (x *calculatorServiceFindMaxNumberClient) Send(m *MaxnumberRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxNumberClient) Recv() (*MaxnumberResponse, error) {
...
func (x *calculatorServiceFindMaxNumberServer) Send(m *MaxnumberResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxNumberServer) Recv() (*MaxnumberRequest, error) {
